...
if (isset($_POST['insert'])) {
	...
	$existing_Query ="SELECT * FROM `addtable` WHERE `event`='$data[0]' OR `description`='$data[1]' OR `start_time`='$data[4]' OR `end_time`='$data[5]'";
    ...
    $insert_Query = "INSERT INTO `addtable` (`event`, `description`,`start_time`, `end_time`) VALUES ('$data[0]', '$data[1]', '$data[4]', '$data[5]')";
