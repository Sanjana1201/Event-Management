...
<nav class="navbar navbar-default">
    ...
    <div class="navbar-header">
      <a class="navbar-brand" href="home.php">EventManager</a>
    </div>
    <div>
    ...
    <ul class="nav navbar-nav">
        ...
        <li><a href="addevent.php"><span class="glyphicon glyphicon-plus-sign"></span> Event</a></li> 
        <li><a href="adddescription.php"><span class="glyphicon glyphicon-plus-sign"></span> Description</a></li>
